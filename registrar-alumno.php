...
if(isset($_SESSION["loggedin"]) && ($_SESSION['tipo'] == "Administrador" || $_SESSION['tipo'] == "Profesor" || $_SESSION['tipo'] == "Alumno")){
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["matricula"]))){
        $matricula_err = "ERROR: Inserta la matricula institucional del alumno.";
    } else{
    ...
    if(empty(trim($_POST["nombre"]))){
        $nombre_err = "ERROR: Inserta el nombre completo del alumno.";
    } else{
...
<head>
  ...
  <title>Sistema Asesorías - Registrar Alumno</title>
              ...
              <!--<div class="col-lg-6 d-none d-lg-block bg-login-image"></div>-->
                <div class="p-2">
                  <div class="text-center">
                    <h1 class="h3 text-gray-800 mb-5">Registrar Alumno</h1>
                  </div>
