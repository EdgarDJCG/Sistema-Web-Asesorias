...
<head>
  ...
  <title>Inicio - Sistema Asesorías</title>
</head>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <!-- Inicio Contenido -->
          <p class="text-center h1 mb-4 text-gray-800">Bienvenido al Sistema de Asesorías</p>
          <p class="text-center h3 mb-4 text-gray-800">El lugar donde miembros de la comunidad se ayudan mutuamente para aprender mejor. Inicia Sesión.</p>
          <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 100rem;" src="img/logo-balunetwork-completo-300px.png" alt="">
          <!-- Fin Contenido -->
        </div>
        ...
        <div class="container-fluid">
          ...
          <div class="text-center">
            <p class="text-center h1 mb-4 text-gray-800">Bienvenido al Sistema de Asesorías</p>
          <p class="text-center h3 mb-4 text-gray-800">El lugar donde miembros de la comunidad se ayudan mutuamente para aprender mejor.</p>
            <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 100rem;" src="img/logo-balunetwork-completo-300px.png" alt="">
          </div>
          <!-- Fin Contenido -->
        </div>
